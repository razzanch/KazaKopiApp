...
import 'package:myapp/app/modules/coffe_powder/views/coffe_powder_view.dart';
...
class StockView extends GetView<StockController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Stock'), // Set your title here
            ...
            children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color:
                            Color(0xFF495048), // Mengubah warna menjadi #495048
                      ),
                    ),
                  ),
                  GestureDetector(
                    ...
                    onTap: () {
                      Get.to(CoffePowderView()); // Navigasi ke CoffeePowderView
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(
                          right:
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      left:
                          30.0), // Memberikan padding ke kiri untuk menggeser kotak ke kanan
                  child: Container(
              ...
              GridView.count(
                ...
                children: [
                  buildCoffeeCard(
                      'Kopi Susu Regular', 'Tersedia', 'assets/M1.png'),
                  buildCoffeeCard(
                      'Kopi Susu Gula Aren', 'Tersedia', 'assets/M2.png'),
                  buildCoffeeCard(
                      'Creamy Signature', 'Tersedia', 'assets/M3.png'),
