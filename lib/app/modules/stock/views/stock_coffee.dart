        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 16), // Jarak antara gambar dan teks "Minuman"
              Row(
                ...
                children: [
                  ...
                  GestureDetector( // Mengubah Padding menjadi GestureDetector
                    onTap: () {
                      Get.to(CoffeePowderView()); // Navigasi ke CoffeePowderView
                    },
                    child: Padding(
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(left: 30.0), // Memberikan padding ke kiri untuk menggeser kotak ke kanan
                  child: Container(
