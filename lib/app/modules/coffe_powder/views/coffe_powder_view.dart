...
import 'package:myapp/app/modules/stock/views/stock_view.dart';
import 'package:myapp/app/routes/app_pages.dart';

import '../controllers/coffe_powder_controller.dart';

class CoffePowderView extends GetView<CoffePowderController> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Bubuk Kopi'), // Set your title here
        backgroundColor: Color(0xFF046E79),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          padding: const EdgeInsets.all(0), // Menghapus padding di sekitar layar
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center, // Menyusun konten secara vertikal
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 16, // Ukuran font diubah menjadi lebih kecil
                            ),
                          ),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20, // Ukuran font untuk MALANG, JAWA TIMUR lebih besar
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 20.0), // Menambah jarak vertikal
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0), // Padding untuk ikon
                              child: Icon(Icons.search, color: Colors.black), // Ikon pencarian
                            ),
                            Expanded(
                              child: TextField(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0), // Jarak kiri dan kanan
                child: SizedBox(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // Mengatur jarak antara dua teks
                children: [
                  GestureDetector(
                    // Mengubah Padding menjadi GestureDetector untuk "Minuman"
                    onTap: () {
                      Get.to(StockView()); // Navigasi ke HomeView
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(left: 55.0), // Memindahkan "Minuman" lebih ke kiri
                      child: Text(
                        'Minuman', // Teks di samping "Bubuk Kopi"
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF495048), // Mengubah warna menjadi #495048
                        ),
                      ),
                    ),
                  ),
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      Get.to(StockView()); // Navigasi ke StockCoffeeView
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(right: 55.0), // Memindahkan "Bubuk Kopi" lebih ke kanan
                      child: Text(
              ...
              Align(
                alignment: Alignment.centerLeft, // Mengatur posisi kotak ke kiri
                child: Padding(
                  padding: const EdgeInsets.only(left: 240.0), // Memberikan padding ke kiri untuk menggeser kotak ke kanan
                  child: Container(
                    ...
                    width: Get.width * 0.3, // Lebar kotak disesuaikan agar lebih pendek
                  ),
                ),
              ),
              ...
              GridView.count(
                ...
                children: [
                  buildCoffeeCard('Robusta', 'Tersedia', 'assets/BK1.png'),
                  buildCoffeeCard('Arabic', 'Tersedia', 'assets/BK2.png'),
                ],
              ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.shopping_cart, color: Color(0xFF495048)), // Ikon Cart
            label: 'Cart',
          ),
        ],
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 4),
          Container(
            padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4), // Padding untuk teks
