          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  // Mengarahkan ke rute yang sesuai berdasarkan jenis menu
                  if (controller.isMinumanSelected.value) {
                    Get.toNamed(Routes.DETAIL_MINUMAN); // Rute untuk detail minuman
                  } else {
                    Get.toNamed(Routes.DETAIL_BUBUK); // Rute untuk detail bubuk kopi
                  }
                },
