...
class _AdminhistoryViewState extends State<AdminhistoryView> {
  ...
  Widget build(BuildContext context) {
    ...
    ? FirebaseFirestore.instance.collection('historyorder').snapshots()
    : FirebaseFirestore.instance
        ...
        .where('date', isLessThan: Timestamp.fromDate(DateTime(
          selectedDate!.year,
          selectedDate!.month,
          selectedDate!.day + 1,
        )))
  ...
  child: StreamBuilder<QuerySnapshot>(
    stream: FirebaseFirestore.instance
        .collection('historyorder')
        .where('username', isNotEqualTo: '') // Filter data dengan username yang tidak kosong
        .snapshots(),
    builder: (context, snapshot) {
      if (!snapshot.hasData) {
        return Center(child: CircularProgressIndicator());
      ...
      for (var doc in snapshot.data!.docs) {
        ...
        // Jika statusnya bukan 'Cancelled', tambahkan totalAmount ke totalIncome
