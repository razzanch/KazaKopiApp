...
class MyanaliticsView extends StatefulWidget {
  const MyanaliticsView({super.key});

  @override
  _MyanaliticsViewState createState() => _MyanaliticsViewState();
}

class _MyanaliticsViewState extends State<MyanaliticsView> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Get.toNamed(Routes.MYHISTORY); // Navigate to ADMINHISTORY route
          },
        ),
        actions: [
  Padding(
      ...
      body: SingleChildScrollView(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .where('uid', isEqualTo: userUid)// Filter data with non-empty username
              .snapshots(),
